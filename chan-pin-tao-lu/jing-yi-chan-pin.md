...
在具体工作工作，需求两个部分，立项之前的需求分析阶段和立项之后的产品设计阶段。在需求阶段，产品经理要确定谁什么时候为什么用我们的什么产品，其中who代表了广度，谁来用；why代表强度，用户为什么用我们的产品；when，用户什么时间、多久使用一次的问题，产出物包括产品市场调查分析报告、产品策划方案等内容。在设计阶段，是立项通过后，通过引入需求场景分析模型，重点落实where、what和how 的问题，将最开始的产品点子细化为用户使用场景，并设计应用层面的技术方案和初步的UI设计，最终形成完善的PRD文档
...
产品强度的高度取决于产品体验，而产品体验部分在产品思维里已经进行过分解。整体而言，能给用户惊喜、超出用户预期的产品体验才是好的体验，好的产品体验是要照顾用户心理和情感。善的或者恶的。
...
我用原则来代替。原则是最开始的出发点，也是产品的边界，当我们在面对抉择时就应该回到原则考虑哪一部分是重要己的。产品的原则可以包含以下几个方面：
...
一个案例是在微信最开始的时候，曾经面临要不要让消息发送着看到对方"已送达"的状态信息，而当时的市场先行者是这样选择的，这保护了信息发送者。而最终微信选择不显示该状态，而是要“给用户说谎的机会”，这种符合人性选择也是推动微信进一步扩张的一个细节。好的规则是要符合人性的，在面临抉择时选择什么，放弃什么。
...
在需求和用研阶段完成后，就应该形成最初步的产品文档，需求文档应该包含以下几项。

![](/assets/PRD.png)交付PRD后就可以进入开发阶段了。
